#!/usr/bin/env bash
# Option 3 cycle for PR 25: DELETE the reviews rule, merge, PUT it back.
# Pre-conditions: PR 25 is open and MERGEABLE; user is the repo admin.
# Post-conditions: PR 25 merged into main; protection restored from canonical file.
...
others = [pr for pr in open_prs if pr["number"] != 25]
if others:
