#!/usr/bin/env bash
# Option 3 cycle for PR 23: DELETE the reviews rule, merge, PUT it back.
# Modeled on scripts/merge_pr18_cycle.sh; generalized to PR 23.
# Pre-conditions: PR 23 is open and MERGEABLE; user is the repo admin.
# Post-conditions: PR 23 merged into main; protection restored from canonical file.
...
others = [pr for pr in open_prs if pr["number"] != 23]
if others:
...
print("PRE-CONDITIONS OK: PR 23 is the only open PR, mergeable, blocked only by the reviews rule.")
PY
